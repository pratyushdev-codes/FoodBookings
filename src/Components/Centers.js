    ...
    <>
      <div  id="concepts">
       ...
       <div className="card" style={{ width: '25rem', marginRight: '1rem', marginBottom: '1rem', borderColor: 'white' }}>
          ...
          {/* <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3670.1974986712976!2d72.48633907531585!3d23.089864979126656!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjPCsDA1JzIzLjUiTiA3MsKwMjknMjAuMSJF!5e0!3m2!1sen!2sin!4v1709289454174!5m2!1sen!2sin" width="400" height="300" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> */}
          ...
          <div className="card" style={{ width: '25rem', marginRight: '1rem', marginBottom: '1rem', borderColor: 'white' }}>
            ...
            <div className="card-body" style={{ textAlign: 'center' }}>
              <h5 className="card-title" style={{
                ...
                fontSize: '20px',
                fontWeight: 'bold',
              }}>Bhadaj Center, Ahmedabad</h5>
              <p className="card-text" style={{
                fontSize: '1rem',
                fontWeight: 'bold',
                color: 'rgba(0, 0, 0, 0.6)',
              }}>Opp - MK Farm,B/H - Indian Oil Petrol Pump,Near SP Ring Road,Bhadaj,Ahmedabad,Gujarat 380060</p>
              <br />
              <a href="https://maps.app.goo.gl/N3B1s4Mx6MjV3fmy6" className="btn btn-primary" style={{ borderRadius: '20px', display: 'inline-block' }}>Direction</a>
            </div>
          </div>
        </div>
      </div>
