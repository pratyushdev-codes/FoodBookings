...
{/* Video 2 */}
   ...
   <div className="card" style={{ width: '100%', margin: '0.5rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', borderRadius: "20px" }}>
       <div className="card-body" style={{  borderRadius: '20px' }}>
       <video src="./images/News/3.mp4" controls style={{ width: "100%", height: "70%" , borderRadius:"20px" , objectFit:"fill" }} />
...
<div className="card" style={{ width: '100%', margin: '0.5rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', borderRadius: "20px" }}>
          <div style={{ display: 'flex', justifyContent: 'center', backgroundColor: "#F4F1FD", flexWrap: 'wrap', borderTopRightRadius: "50px", borderBottomLeftRadius: "50px" }}>
            <div className="card" style={{ width: '23rem', height: "23rem", margin: '0.25rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', borderRadius: "20px" }}>
              <img src="./images/News/14.jpeg" className="card-img-top" alt="Image 1" style={{ height: '300px', borderRadius: '20px' }} />
            </div>

    <div className="card" style={{ width: '23rem', height:"23rem",margin: '0.25rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', borderRadius: "20px" }}>
      <img src="./images/News/15.jpeg" className="card-img-top" alt="Image 1" style={{ height: '370px', borderRadius: '20px' }} />
    </div>

    <div className="card" style={{ width: '23rem',height:"23rem", margin: '0.25rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', borderRadius: "20px" }}>
      <img src="./images/News/18.jpeg" className="card-img-top" alt="Image 1" style={{ height: '370px', borderRadius: '20px' }} />
    </div>
  </div>
</div>
...
<div className="card" style={{ width: '100%', margin: '0.5rem', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', borderRadius: "20px" }}>
       <div className="card-body" style={{  borderRadius: '20px' }}>
       <video src="./images/News/2.mp4" controls style={{ width: "100%", height: "70%" , borderRadius:"20px" , objectFit:"fill" }} />
